<template>
  <el-dialog title="新增用户" :visible.sync="innerVisible" width="640px">
    <el-form :gutter="20" class="add-user-form" :rules="rules" label-width="100px">
      <el-form-item class="add-user-form-input" label="role name" prop="name">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: 'role name 不能为空', trigger: 'blur' },
        ],
      }
    }
  },
